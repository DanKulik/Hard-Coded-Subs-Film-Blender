...
def hc_fix(**kwargs):
    ...
    i = 0
    per = 0
    pbar = tqdm(total=100, initial=per)
    ...
    fin_time = time.time()
    print("\nTask completed in: " + time.strftime("%H:%M:%S", time.gmtime(fin_time-str_time)))

#example
'''hc_fix(in_name='input.mp4', out_name='output.mp4', fps=23.976, \
